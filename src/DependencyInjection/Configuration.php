                        ...
                        ->children()
                            ...
                            ->arrayNode('options')
                                ->children()
                                    ...
                                    ->arrayNode('blur')
                                        ->children()
                                            ->floatNode('sigma')->min(0)->end()
                                        ->end()
                                    ->end()
                                    ->arrayNode('quality')
                                        ->children()
                                            ->integerNode('quality')->min(0)->end()
                                        ->end()
                                    ->end()
                                    ->arrayNode('watermark')
                                        ->children()
                                            ->floatNode('opacity')->min(0)->max(1)->end()
                                            ->enumNode('position')
                                                ->values(['ce', 'no', 'so', 'ea', 'we', 'noea', 'nowe', 'soea', 'sowe', 're'])
                                                ->defaultValue('ce')
                                            ->end()
                                            ->integerNode('x_offset')->defaultValue(0)->end()
                                            ->integerNode('y_offset')->defaultValue(0)->end()
                                            ->floatNode('scale')->min(0)->defaultValue(0)->end()
                                        ->end()
                                    ->end()
                                ->end()
                            ->end()
